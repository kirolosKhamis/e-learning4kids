    ...
    <div class="row">
            ...
            <div class="col-lg-10 col-sm-6 col4">
                ...
                <div class="form-check form-check-inline">
                  ...
                  <input class="form-check-input" type="radio" name="Is_talkative" id="Is_talkative" value="Strongly disagree">
                  <label class="form-check-label" for="Strongly_disagree">Strongly disagree</label>

                  <input class="form-check-input" type="radio" name="Is_talkative" id="Is_talkative" value="Disagree a little">
                  <label class="form-check-label" for="Disagree_a_little">Disagree a little</label>

                  <input class="form-check-input" type="radio" name="Is_talkative" id="Is_talkative" value="Neither agree nor disagree">
                  <label class="form-check-label" for="Neither_agree_nor_disagree">Neither agree nor disagree</label>

                  <input class="form-check-input" type="radio" name="Is_talkative" id="Is_talkative" value="Agree a little">
                  <label class="form-check-label" for="Agree_a_little">Agree a little </label>

                  <input class="form-check-input" type="radio" name="Is_talkative" id="Is_talkative" value="Strongly agree">
                ...
                <div class="form-check form-check-inline">
                  ...
                  <input class="form-check-input" type="radio" name="Tends_to_find_fault_with_others" id="Tends_to_find_fault_with_others" value="Disagree a little">
                  <label class="form-check-label" for="Disagree_a_little">Disagree a little</label>

                  <input class="form-check-input" type="radio" name="Tends_to_find_fault_with_others" id="Tends_to_find_fault_with_others" value="Neither agree nor disagree">
                  <label class="form-check-label" for="Neither_agree_nor_disagree">Neither agree nor disagree</label>

                  <input class="form-check-input" type="radio" name="Tends_to_find_fault_with_others" id="Tends_to_find_fault_with_others" value="Agree a little">
                  <label class="form-check-label" for="Agree_a_little">Agree a little </label>

                  <input class="form-check-input" type="radio" name="Tends_to_find_fault_with_others" id="Tends_to_find_fault_with_others" value="Strongly agree">
                  <label class="form-check-label" for="Strongly_agree">Strongly agree</label>
                </div>
