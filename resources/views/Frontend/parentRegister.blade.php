...
<section class="register text-center">
    ...
    <div class="container">
    <form action="../PHP/parentreg.php" method="POST" role="role">
<div class="col-md-6 wow fadeInUp"data-wow-duration="1s" data-wow-offset="300" >
      ...
      <div class="form-group">
        <input type="number" class="form-control input-lg"  placeholder="Number of Children" name="Number_of_Children">
    </div>
      <div class="form-group">
