...
<body>
    ...
    {{-- <div class="row">
      <div class="col-lg-6 col-md-3 col-sm-3"> --}}
        {{-- <p>{{$details['courseCode']}}</p>
        <p>{{$details['Reg']}}</p> --}}
      {{-- </div>
      <div class="col-lg-6 col-md-3 col-sm-3">
        <img src="{{asset('images/offer2.jpeg')}}" alt="about">" alt="">
      </div>
    </div> --}}
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You are receiving this email because you have deadline towmorrow</p><br><p>Would you like to Submit it?</p>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">This link will Direct you to the login page.</p>
