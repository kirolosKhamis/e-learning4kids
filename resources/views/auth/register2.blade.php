...
<section class="register text-center">
    ...
    <div class="col-md-6 wow fadeInUp"data-wow-duration="1s" data-wow-offset="300" >
        ...
        <div class="form-group">
          <input type="email" class="form-control input-lg"  placeholder="Parent Email" name="parent_id">
      </div>
      <div class="form-group">
          <input type="text" class="form-control input-lg"  placeholder="Educational Level" name="term">
      </div>
      <div class="form-group">
    ...
    <div class="form-group">
      <input type="email" class="form-control input-lg"  placeholder="Email" value="{{ old('student_id') }}" name="student_id">
  </div>
    <div class="form-group">
